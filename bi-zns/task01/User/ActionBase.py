...
class ActionBase(IActionBase):
    ...
    * etc...
    ...
    def build_knight(self, position_q: int, position_r: int):
    ...
    def build_archer(self, position_q: int, position_r: int):
    ...
    def build_ent(self, position_q: int, position_r: int):
    ...
    def build_druid(self, position_q: int, position_r: int):
